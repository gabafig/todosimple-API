...
import com.gabrielcazzeri.todosimple.models.enums.ProfileEnum;
...
public class User {
    ...
    @GeneratedValue(strategy = GenerationType.IDENTITY) // Identifica a estratégia de geração automática do tipo "Identity"
